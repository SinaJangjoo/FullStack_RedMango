            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (menuItemUpdateDTO.File != null && menuItemUpdateDTO.File.Length > 0)
                    {
                        ...
                        menuItemFromDB.Image = await _blobService.UploadBlob(fileName, SD.SD_Storage_Container, menuItemUpdateDTO.File);  // After we deleted the last image before, Now we upload our new image
                    }
